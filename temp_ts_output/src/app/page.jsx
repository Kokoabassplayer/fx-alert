...
const UsdThbMonitorPage = () => {
    const [alertPrefs, setAlertPrefs] = useLocalStorage("alertPrefs", DEFAULT_ALERT_PREFS);
    const [selectedFromCurrency, setSelectedFromCurrency] = useState('USD');
    const [selectedToCurrency, setSelectedToCurrency] = useState('THB'); // Changed default to THB
    return (<div className="min-h-screen bg-background text-foreground flex flex-col items-center p-4 sm:p-6">
      ...
      <main className="w-full max-w-4xl space-y-6">
        <CurrentRateDisplay alertPrefs={alertPrefs} onAlertPrefsChange={setAlertPrefs} fromCurrency={selectedFromCurrency} toCurrency={selectedToCurrency} onFromCurrencyChange={setSelectedFromCurrency} onToCurrencyChange={setSelectedToCurrency}/>
        <HistoryChartDisplay alertPrefs={alertPrefs} fromCurrency={selectedFromCurrency} toCurrency={selectedToCurrency}/>
        <AnalysisDisplay fromCurrency={selectedFromCurrency} toCurrency={selectedToCurrency}/>
      </main>
